            ...
            <div class = "forgot-password-container-form">
                <div class = "modal-content-forgot-password">
                    ...
                    <?php
                        ...
                        // check for any key values in the previous codes
                        if (isset($_GET["token"]) && isset($_GET["email"])) {
                            ...
                            $prepare_stmt = mysqli_stmt_prepare($stmt_select, $sql_select);
                            ...
                            if ($prepare_stmt) {
                                ...
                                if ($user === null) {
                                    ...
                                    if (isset($user["reset_unique_key_expiry_time"]) && strtotime($user["reset_unique_key_expiry_time"]) <= time()) {
                                ...
                                if (count($errors) > 0) {
                                    ...
                                    echo "<div class = 'text-success'>
                                        <span class = 'close-btn' onclick = 'alertBox()'>&times;</span>
                                        Token value is valid and has not expired.
                                    </div>";
                    ...
                    <form class = "forgot-password-modal-content" action = "process_reset_password.php" method = "post">
                        <br>
                        <!-- image container -->
                        ...
                        <div class = "forgot-password-profile">
                            ...
                            <div class = "forgot-password-field" style = "text-align: center;">
                                <i id = "button-icon-forgot-password" class = "bi bi-save-fill"></i>
                            ...
                            <div class = "forgot-password-field">
                                <i id = "button-icon-forgot-password" class = "bi bi-unlock-fill"></i>
                                <label for = "pass"><b>New Password</b></label>
                                <input type = "password" class = "forgot-password-input" placeholder = "Enter Password" name = "pass">
                            </div>

                            <div class = "forgot-password-field">
                                <i id = "button-icon-forgot-password" class = "bi bi-unlock-fill"></i>
                                <label for = "repass"><b>Confirm Password</b></label>
                                <input type = "password" class = "forgot-password-input" placeholder = "Confirm Password" name = "repass">
                            </div>

                            <div class = "forgot-password-field">
                                <hr>
                                <!-- forgot-password button -->
                                <button type = "submit" name = "forgot-password-submit" class = "forgot-password-submit">Reset Password</button>
                                <!-- <br><br><br>     -->
                            </div>
                        </div>
                    </form>
